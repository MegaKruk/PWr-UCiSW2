...
<drawing version="7">
    ...
    <netlist>
        ...
        <blockdef name="rotR2">
            <timestamp>2018-5-2T15:1:38</timestamp>
            <rect width="336" x="64" y="-128" height="128" />
            <rect width="64" x="0" y="-108" height="24" />
            <line x2="0" y1="-96" y2="-96" x1="64" />
            <rect width="64" x="0" y="-44" height="24" />
        ...
        <block symbolname="rotR2" name="XLXI_178">
    ...
    <sheet sheetnum="1" width="3520" height="2720">
        <instance x="944" y="512" name="XLXI_1" orien="R0">
        </instance>
        <instance x="432" y="672" name="XLXI_2" orien="R0">
        </instance>
        ...
        <instance x="1376" y="672" name="XLXI_4" orien="R0">
        </instance>
        <branch name="XLXN_18(0:47)">
            <wire x2="1376" y1="640" y2="640" x1="1360" />
        </branch>
        <instance x="1840" y="672" name="XLXI_8" orien="R0">
        </instance>
        ...
        <instance x="2320" y="608" name="XLXI_9" orien="R0">
        </instance>
        <branch name="XLXN_40(0:47)">
            <wire x2="1024" y1="592" y2="592" x1="896" />
            <wire x2="896" y1="592" y2="704" x1="896" />
            <wire x2="912" y1="704" y2="704" x1="896" />
            <wire x2="1024" y1="528" y2="592" x1="1024" />
            <wire x2="1472" y1="528" y2="528" x1="1024" />
        ...
        <branch name="leftKeyOut(0:27)">
            ...
            <wire x2="400" y1="528" y2="640" x1="400" />
            <wire x2="400" y1="640" y2="768" x1="400" />
            <wire x2="1280" y1="768" y2="768" x1="400" />
            <wire x2="2816" y1="768" y2="768" x1="1280" />
            <wire x2="928" y1="480" y2="480" x1="896" />
            <wire x2="944" y1="480" y2="480" x1="928" />
            <wire x2="928" y1="480" y2="528" x1="928" />
        </branch>
        <branch name="leftIn(0:31)">
            <wire x2="2112" y1="320" y2="512" x1="2112" />
            <wire x2="2304" y1="512" y2="512" x1="2112" />
            <wire x2="2320" y1="512" y2="512" x1="2304" />
        </branch>
        <branch name="rightKeyOut(0:27)">
            <wire x2="912" y1="544" y2="544" x1="384" />
            <wire x2="384" y1="544" y2="848" x1="384" />
            <wire x2="1280" y1="848" y2="848" x1="384" />
            <wire x2="2816" y1="848" y2="848" x1="1280" />
            <wire x2="912" y1="416" y2="416" x1="896" />
            <wire x2="944" y1="416" y2="416" x1="912" />
            <wire x2="912" y1="416" y2="544" x1="912" />
        </branch>
        ...
        <branch name="rightIn(0:31)">
            <wire x2="368" y1="640" y2="640" x1="320" />
            <wire x2="368" y1="640" y2="704" x1="368" />
            <wire x2="416" y1="704" y2="704" x1="368" />
            <wire x2="416" y1="640" y2="704" x1="416" />
            <wire x2="432" y1="640" y2="640" x1="416" />
        </branch>
        <branch name="rightOut(0:31)">
            <wire x2="2816" y1="512" y2="512" x1="2784" />
        </branch>
        <iomarker fontsize="28" x="2112" y="320" name="leftIn(0:31)" orien="R270" />
        <iomarker fontsize="28" x="2816" y="768" name="leftKeyOut(0:27)" orien="R0" />
        <iomarker fontsize="28" x="2816" y="848" name="rightKeyOut(0:27)" orien="R0" />
        <iomarker fontsize="28" x="320" y="416" name="rightKeyIn(0:27)" orien="R180" />
        <iomarker fontsize="28" x="320" y="480" name="leftKeyIn(0:27)" orien="R180" />
        <iomarker fontsize="28" x="320" y="640" name="rightIn(0:31)" orien="R180" />
        <iomarker fontsize="28" x="2816" y="512" name="rightOut(0:31)" orien="R0" />
        <instance x="432" y="512" name="XLXI_178" orien="R0">
        </instance>
    </sheet>
</drawing>