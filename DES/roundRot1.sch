...
<drawing version="7">
    ...
    <sheet sheetnum="1" width="3520" height="2720">
        ...
        <instance x="592" y="544" name="XLXI_2" orien="R0">
        </instance>
        ...
        <instance x="1536" y="544" name="XLXI_4" orien="R0">
        </instance>
        <branch name="XLXN_18(0:47)">
            <wire x2="1536" y1="512" y2="512" x1="1520" />
        </branch>
        <instance x="2000" y="544" name="XLXI_8" orien="R0">
        </instance>
        <branch name="XLXN_19(0:31)">
            <wire x2="2000" y1="512" y2="512" x1="1984" />
        </branch>
        <branch name="XLXN_20(0:31)">
            <wire x2="2464" y1="512" y2="512" x1="2448" />
            <wire x2="2480" y1="448" y2="448" x1="2464" />
            <wire x2="2464" y1="448" y2="512" x1="2464" />
        </branch>
        <instance x="2480" y="480" name="XLXI_9" orien="R0">
        </instance>
        <branch name="XLXN_40(0:47)">
            <wire x2="1184" y1="464" y2="464" x1="1056" />
            <wire x2="1056" y1="464" y2="576" x1="1056" />
            <wire x2="1072" y1="576" y2="576" x1="1056" />
            <wire x2="1184" y1="400" y2="464" x1="1184" />
            <wire x2="1632" y1="400" y2="400" x1="1184" />
            <wire x2="1632" y1="288" y2="288" x1="1552" />
            <wire x2="1632" y1="288" y2="400" x1="1632" />
        </branch>
        <instance x="592" y="384" name="XLXI_176" orien="R0">
        </instance>
        <branch name="leftKeyOut(0:27)">
            <wire x2="640" y1="400" y2="400" x1="560" />
            <wire x2="1088" y1="400" y2="400" x1="640" />
            <wire x2="560" y1="400" y2="512" x1="560" />
            <wire x2="560" y1="512" y2="640" x1="560" />
            <wire x2="1440" y1="640" y2="640" x1="560" />
            <wire x2="2976" y1="640" y2="640" x1="1440" />
            <wire x2="1088" y1="352" y2="352" x1="1056" />
            <wire x2="1104" y1="352" y2="352" x1="1088" />
            <wire x2="1088" y1="352" y2="400" x1="1088" />
        </branch>
        <branch name="leftIn(0:31)">
            <wire x2="2272" y1="192" y2="384" x1="2272" />
        ...
        <branch name="rightKeyOut(0:27)">
            ...
            <wire x2="544" y1="416" y2="720" x1="544" />
            <wire x2="1440" y1="720" y2="720" x1="544" />
            <wire x2="2976" y1="720" y2="720" x1="1440" />
            <wire x2="1072" y1="288" y2="288" x1="1056" />
            <wire x2="1104" y1="288" y2="288" x1="1072" />
            <wire x2="1072" y1="288" y2="416" x1="1072" />
        </branch>
        <iomarker fontsize="28" x="2976" y="640" name="leftKeyOut(0:27)" orien="R0" />
        <iomarker fontsize="28" x="2976" y="720" name="rightKeyOut(0:27)" orien="R0" />
        <branch name="rightKeyIn(0:27)">
            <wire x2="576" y1="288" y2="288" x1="480" />
            <wire x2="592" y1="288" y2="288" x1="576" />
        </branch>
        <branch name="leftKeyIn(0:27)">
            <wire x2="576" y1="352" y2="352" x1="480" />
